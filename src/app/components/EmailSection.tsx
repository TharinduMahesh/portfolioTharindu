      ...
      <div>
        ...
        <div className='socials flex flex-row gap-2'>
          <Link href="https://github.com/your-github" target="_blank">
            <Image src="/images/github.gif" alt="Github Icon" width={30} height={30} className="rounded-full mr=5 " />
          </Link>
          <Link href="https://linkedin.com/in/your-linkedin" target="_blank">
            <Image src="/images/linkedin.gif" alt="Linkedin Icon" width={30} height={30}   className="rounded-md mr-5" />
          </Link>
        </div>
      </div>
      <div>
        {emailSubmitted ? (
          ...
          <form className='flex flex-col' onSubmit={handleSubmit}>
            ...
            <button type="submit"
  className="bg-gradient-to-br from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white font-medium py-2.5 px-5 rounded-lg w-full">
  Send Message
</button>
          </form>
        )}
